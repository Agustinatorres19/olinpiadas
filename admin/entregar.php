    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="entregados.php">Entregar</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="historialpedidos.php">Historial de pedidos</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM peticion_compras WHERE nombre LIKE ? AND proceso = 'approved'";
                ...
                <tr>
                    ...
                    <td>
                        <a href="modificarpeti.php?id=<?= htmlspecialchars($datos['id_peticiones_compras'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-small btn-secondary" onclick="confirmModificar(event)">Aceptar</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
...
<script>
    function confirmModificar(event) {
        ...
        Swal.fire({
            title: '¿Quieres aceptar este pedido?',
            text: "Asegúrate de que estás listo para comenzar a entregar.",
            icon: 'info',
